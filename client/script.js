document.addEventListener('DOMContentLoaded', () => {
    ...
    const initializeApp = async () => {
        ...
        // --- ZJEDNODUŠENÁ LOGIKA ZDE ---
        // Nyní již nic nevytváříme, pouze najdeme existující prvky.
        const menu = document.getElementById('menu');
        const langSwitcher = document.getElementById('language-switcher');

        // Naplníme přepínač jazyků tlačítky
    ...
    (function() {
        ...
        // aby byla odpověď přehlednější, ale kód kompletní.
        const funcs = {
            populateContactInfo: `
            ...
            setupBookingForm: `
                ...
                const updatePrice = async () => {
                    ...
                    if (!isDateAvailable(startDate, endDate)) {
                        errorEl.textContent = translations[currentLang].error_message; return;
                    }
                    try {
